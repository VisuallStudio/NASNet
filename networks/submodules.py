...
from ofa.utils.my_modules import LCM
import copy
...
class ResBlock(nn.Module):
    def __init__(self, n_in, n_out, kernel_size=3, stride=1):
        ...
        self.conv1 = nn.Conv2d(n_in, n_out, kernel_size=kernel_size, stride=stride, padding=(kernel_size - 1) // 2)
        self.bn1 = nn.BatchNorm2d(n_out)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = nn.Conv2d(n_out, n_out, kernel_size=kernel_size, padding=(kernel_size - 1) // 2)
